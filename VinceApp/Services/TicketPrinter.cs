...
namespace VinceApp.Services
{
    public class TicketPrinter
    {
        ...
        private Font fontBody = new Font("Arial", 9, System.Drawing.FontStyle.Bold);
        ...
        public TicketPrinter()
        {
            ...
            fmtLeft.Alignment = StringAlignment.Far;
        ...
        public void Print(int orderId, bool isKitchenTicket)
        {
            ...
            // === تعديل 1: تحديد الطابعة المحفوظة في الإعدادات ===
            try
            {
                using (var context = new VinceSweetsDbContext())
                {
                    ...
                    if (settings != null && !string.IsNullOrEmpty(settings.PrinterName))
                    {
        ...
        private void pDoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            using (var context = new VinceSweetsDbContext())
            {
                ...
                // (تأكد من وجود using Microsoft.EntityFrameworkCore; في أعلى الملف)
